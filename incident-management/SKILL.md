...
```bash
python3 .codex/skills/incident-management/scripts/generate_incident_report.py --input data/incidents/<input-file>.json
```

如需校验事故模板一致性，可使用：

```bash
python3 .codex/skills/incident-management/scripts/validate_incident_templates.py --scope incident
```
